...
class ChurchClient(Client):
    ...
    @abstractmethod
    async def async_get_task(self, endpoint: str = "get_task", repeat_delay: int = 2) -> ChurchTask:
        """
    ...
    @abstractmethod
    async def async_submit_task(self, church_task: ChurchTask, endpoint: str = "submit_task") -> requests.Response:
        """
